    ...
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-main">
          <div class="footer-brand">
            <h3 class="brand-title neon-glow">sxl193258.tech</h3>
      ...
      <div class="footer-bottom">
        ...
        <div class="tech-info">
          ...
          <span class="tech-badge">科技感主题</span>
        </div>
      </div>
    </div>
  </footer>
